...
*************************************************************/
            ...
            int m = plist->size;
           /* if(access("/home/idolphint/darknet/results/out",0)==-1)//"/home/FENGsl/darknet/data"修改成自己的路径
            {
              if (mkdir("/home/idolphint/darknet/results/out",0777))//"/home/FENGsl/darknet/data"修改成自己的路径
               {
	    ...
	    /**************************
             char b[2048];
            sprintf(b,"/home/idolphint/darknet/results/out/%s",GetFilename(path));//"/home/FENGsl/darknet/data"修改成自己的路径
